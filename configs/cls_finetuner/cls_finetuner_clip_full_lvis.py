...
### there is an mistake in lvisv1 dataset
### speaker_(stereo_equipment) is misspelled into speaker_(stero_equipment)

# so in the dataset config we still use the speaker_(stero_equipment)
# while in the generating the text embedding we use the speaker_(stereo_equipment)
# to maintain the precise semantic meaning
