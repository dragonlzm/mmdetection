...
train_pipeline = [
    ...
    dict(type='LoadCLIPFeat', file_path_prefix='data/coco/clip_proposal_feat/imagenet1762_finetuned',
         num_of_rand_bbox=200, select_fixed_subset=200, load_rand_bbox_weight=True, use_base_discount_objectness=True),    
