_base_ = './mask_rcnn_distillation_voc_split3_base_r101_fewshot_dataset_rpn_proposal_raw.py'
...
train_pipeline = [
    ...
    dict(type='LoadCLIPFeat', file_path_prefix='data/VOCdevkit/rpn_proposal_feat/split3_raw',
