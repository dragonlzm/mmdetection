# this script is for testing the feature from the channel corrected proposal generator
...
train_pipeline = [
    ...
    dict(type='LoadCLIPFeat', file_path_prefix='data/coco/clip_proposal_feat/base48_finetuned_channel_corr',
