...
json_content = json.load(open('/data/zhuoming/detection/coco/annotations/instances_train2017.json'))

num_img = 10
img_list = json_content['images']
random.shuffle(img_list)

selected_img = img_list[:num_img]
...
file = open('/data/zhuoming/detection/coco/annotations/train_' + str(num_img) + 'imgs.json', 'w')
