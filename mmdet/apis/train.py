...
from mmcv.runner import (HOOKS, DistSamplerSeedHook, EpochBasedRunner,
                         ...
                         build_runner)
from mmcv.utils import build_from_cfg, ConfigDict

from mmdet.core import (DistEvalHook, EvalHook, QuerySupportDistEvalHook,
                                      QuerySupportEvalHook)
from mmdet.datasets import (build_dataloader, build_dataset,
                            replace_ImageToTensor, get_copy_dataset_type)
from mmdet.utils import get_root_logger, compat_cfg
...
def train_fewshot_detector(model: nn.Module,
                   dataset: Iterable,
                   cfg: ConfigDict,
