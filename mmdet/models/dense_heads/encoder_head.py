...
class EncoderHead(AnchorFreeHead):
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        if (version is None or version < 2) and self.__class__ is EncoderHead:
            convert_dict = {
    ...
    def loss(self,
        ...
        num_enc_layers = len(all_cls_scores)
        all_gt_bboxes_list = [gt_bboxes_list for _ in range(num_enc_layers)]
