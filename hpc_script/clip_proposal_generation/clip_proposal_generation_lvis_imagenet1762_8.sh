...
# generating the CLIP proposal on LVIS dataset using the ImageNet name (1762 both leaf names and non-leaf names), this task will be distributed in 13 subtasks
