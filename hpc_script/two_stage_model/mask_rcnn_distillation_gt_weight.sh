...
# base_filtered gt weight = 100
WORK_DIR="/project/nevatia_174/zhuoming/detection/grad_clip_check/mask_rcnn_with_base48_tuned_clip_feat_r50_fpn_1x_coco_base48_200clip_base_filtered_pro_reg_with_embedding_nw_gtw100"
...
python -m torch.distributed.launch --nproc_per_node=2 \
    ...
    model.train_cfg.rcnn.gt_bboxes_distill_weight=100.0 \
