...
# Mask R-CNN with distillation training with LVIS dataset, with multi-scale augmentation
...
COMBINE_METHOD='cat'
WORK_DIR="/project/nevatia_174/zhuoming/detection/grad_clip_check/mask_rcnn_distillation_multi_scale"
PYTHONPATH="/project/nevatia_174/zhuoming/code/new_rpn/mmdetection":$PYTHONPATH \
python -m torch.distributed.launch --nproc_per_node=2 \
    /project/nevatia_174/zhuoming/code/new_rpn/mmdetection/tools/train.py \
    configs/mask_rcnn_distill/mask_rcnn_distillation_multi_scale.py --launcher pytorch \
    --work-dir=${WORK_DIR} \
