...
python -m torch.distributed.launch --nproc_per_node=2 \
    ...
    configs/cls_finetuner/cls_finetuner_clip_base_all_train_focal.py --launcher pytorch \
    --work-dir=/project/nevatia_174/zhuoming/detection/test/cls_finetuner_clip_base_all_train_focal
