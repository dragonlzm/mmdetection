...
# using all categories finetuned CLIP, On COCO dataset
...
python -m torch.distributed.launch --nproc_per_node=2 \
    ...
    --cfg-options model.test_cfg.crop_loca_modi=0.2 data.test.visualization_path=/home1/liuzhuom/mmdetection/visualization_loca_full
...
python -m torch.distributed.launch --nproc_per_node=2 \
    ...
    /project/nevatia_174/zhuoming/detection/test/cls_finetuner_clip_full_coco/epoch_12.pth \
    --launcher pytorch --eval=gt_acc --options jsonfile_prefix=/home1/liuzhuom/mmdetection/results \
    --cfg-options model.test_cfg.crop_loca_modi=0.25 data.test.visualization_path=/home1/liuzhuom/mmdetection/visualization_loca_full
...
python -m torch.distributed.launch --nproc_per_node=2 \
    ...
    /project/nevatia_174/zhuoming/detection/test/cls_finetuner_clip_full_coco/epoch_12.pth \
    --launcher pytorch --eval=gt_acc --options jsonfile_prefix=/home1/liuzhuom/mmdetection/results \
    --cfg-options model.test_cfg.crop_loca_modi=0.33 data.test.visualization_path=/home1/liuzhuom/mmdetection/visualization_loca_full
...
python -m torch.distributed.launch --nproc_per_node=2 \
    ...
    /project/nevatia_174/zhuoming/detection/test/cls_finetuner_clip_full_coco/epoch_12.pth \
    --launcher pytorch --eval=gt_acc --options jsonfile_prefix=/home1/liuzhuom/mmdetection/results \
    --cfg-options model.test_cfg.crop_loca_modi=0.5 data.test.visualization_path=/home1/liuzhuom/mmdetection/visualization_loca_full
