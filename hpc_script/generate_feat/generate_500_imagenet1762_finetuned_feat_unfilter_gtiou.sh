...
# without filtering the CLIP proposal using the GT bboxes
...
## generate imagenet1762_finetuned_unfiltered feature
#1
...
model.test_cfg.generate_bbox_feat=True model.test_cfg.feat_save_path=data/coco/clip_proposal_feat/imagenet1762_finetuned_unfiltered \
...
data.test.eval_filter_empty_gt=False model.base_cate_name='coco_base_only' model.test_cfg.filter_low_iou_bboxes=False
