...
PYTHONPATH="/project/nevatia_174/zhuoming/code/generate_feat/mmdetection":$PYTHONPATH \
python -m torch.distributed.launch --nproc_per_node=2 \
   /project/nevatia_174/zhuoming/code/generate_feat/mmdetection/tools/test.py \
   ...
   model.test_cfg.generate_bbox_feat=True model.test_cfg.feat_save_path=data/coco/clip_proposal_feat/base48_finetuned_base_filtered_1xrandom_sorted \
