...
WORK_DIR="/project/nevatia_174/zhuoming/detection/grad_clip_check/faster_rcnn_distill_r50_fpn_1x_coco"
PYTHONPATH="/project/nevatia_174/zhuoming/code/new_rpn/mmdetection":$PYTHONPATH \
python -m torch.distributed.launch --nproc_per_node=2 \
    /project/nevatia_174/zhuoming/code/new_rpn/mmdetection/tools/train.py \
    configs/faster_rcnn_distill/faster_rcnn_distill_r50_fpn_1x_coco.py --launcher pytorch \
    --work-dir=${WORK_DIR} \
...
bash tools/dist_test.sh configs/faster_rcnn_distill/mask_rcnn_with_base48_tuned_clip_feat_r50_fpn_1x_coco_base48.py \
...
bash tools/dist_test.sh configs/faster_rcnn_distill/mask_rcnn_with_base48_tuned_clip_feat_r50_fpn_1x_coco_novel17.py \
${WORK_DIR}/${CHECKPOINT_NAME} 2 --eval bbox segm \
...
bash tools/dist_test.sh configs/faster_rcnn_distill/mask_rcnn_with_base48_tuned_clip_feat_r50_fpn_1x_coco_bn65.py \
${WORK_DIR}/${CHECKPOINT_NAME} 2 --eval bbox segm \
