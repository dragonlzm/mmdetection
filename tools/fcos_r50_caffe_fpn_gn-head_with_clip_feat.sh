...
data/fcos/fcos_r50_caffe_fpn_gn-head_with_base48_tuned_clip_feat_1x_coco_base48_w01/epoch_12.pth 2 --eval bbox \
--eval-options jsonfile_prefix=data/fcos/fcos_r50_caffe_fpn_gn-head_with_base48_tuned_clip_feat_1x_coco_base48_w01/base \
