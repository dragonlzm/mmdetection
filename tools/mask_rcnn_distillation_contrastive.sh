...
# 200 clip proposal filpping(reg with class embedding, cat, distillation weight=1, contrastive weight=0.5)
# COMBINE_METHOD='cat'
# WORK_DIR="/project/nevatia_174/zhuoming/detection/grad_clip_check/mask_rcnn_distillation_w1_contrast_w05"
...
#     model.train_cfg.rcnn.use_contrast_distill=True \
#     model.roi_head.bbox_head.combine_reg_and_cls_embedding=${COMBINE_METHOD} \
#     #--resume-from=${WORK_DIR}/latest.pth

# 200 clip proposal filpping(reg with class embedding, cat, distillation weight=1, contrastive weight=1)
# COMBINE_METHOD='cat'
# WORK_DIR="/project/nevatia_174/zhuoming/detection/grad_clip_check/mask_rcnn_distillation_w1_contrast_w1"
# PYTHONPATH="/project/nevatia_174/zhuoming/code/new_rpn/mmdetection":$PYTHONPATH \
# python -m torch.distributed.launch --nproc_per_node=2 \
#     /project/nevatia_174/zhuoming/code/new_rpn/mmdetection/tools/train.py \
#     configs/mask_rcnn_distill/mask_rcnn_with_base48_tuned_clip_feat_r50_fpn_1x_coco_base48_200clip_pro_reg_with_embedding.py --launcher pytorch \
#     --work-dir=${WORK_DIR} \
#     --cfg-options model.roi_head.bbox_head.temperature=100 model.train_cfg.rcnn.distill_loss_factor=1 optimizer_config.grad_clip.max_norm=10 \
#     model.train_cfg.rcnn.use_contrast_distill=True model.train_cfg.rcnn.contrastive_weight=1 \
#     model.roi_head.bbox_head.combine_reg_and_cls_embedding=${COMBINE_METHOD} \
#     #--resume-from=${WORK_DIR}/latest.pth


# 200 clip proposal filpping(reg with class embedding, cat, distillation weight=0.5, contrastive weight=0.5)
COMBINE_METHOD='cat'
WORK_DIR="/project/nevatia_174/zhuoming/detection/grad_clip_check/mask_rcnn_distillation_w05_contrast_w05"
PYTHONPATH="/project/nevatia_174/zhuoming/code/new_rpn/mmdetection":$PYTHONPATH \
python -m torch.distributed.launch --nproc_per_node=2 \
    /project/nevatia_174/zhuoming/code/new_rpn/mmdetection/tools/train.py \
    configs/mask_rcnn_distill/mask_rcnn_with_base48_tuned_clip_feat_r50_fpn_1x_coco_base48_200clip_pro_reg_with_embedding.py --launcher pytorch \
...
# 200 clip proposal filpping(reg with class embedding, cat, distillation weight=0.5, contrastive weight=1)
# COMBINE_METHOD='cat'
# WORK_DIR="/project/nevatia_174/zhuoming/detection/grad_clip_check/mask_rcnn_distillation_w05_contrast_w1"
# PYTHONPATH="/project/nevatia_174/zhuoming/code/new_rpn/mmdetection":$PYTHONPATH \
# python -m torch.distributed.launch --nproc_per_node=2 \
#     /project/nevatia_174/zhuoming/code/new_rpn/mmdetection/tools/train.py \
#     configs/mask_rcnn_distill/mask_rcnn_with_base48_tuned_clip_feat_r50_fpn_1x_coco_base48_200clip_pro_reg_with_embedding.py --launcher pytorch \
