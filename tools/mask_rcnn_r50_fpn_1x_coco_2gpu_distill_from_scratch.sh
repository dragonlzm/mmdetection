...
python -m torch.distributed.launch --nproc_per_node=2 \
    ...
    --work-dir=/project/nevatia_174/zhuoming/detection/test/mask_rcnn_distill_r50_fpn_1x_coco_2gpu_base48_from_scratch \
    --resume-from=/project/nevatia_174/zhuoming/detection/test/mask_rcnn_distill_r50_fpn_1x_coco_2gpu_base48_from_scratch/epoch_8.pth