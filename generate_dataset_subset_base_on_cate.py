...
if __name__ == "__main__":
    ...
    result_path = '/data/zhuoming/detection/lvis_v1/annotations/lvis_v1_val_cnr.json'
    generate_data_set_base_on_cates(dataset_path, cnr_name, result_path)